...
//
// Every log entry includes: timestamp, level, service, environment, version,
// trace_id, span_id, and message — conforming to the Tier 1 log schema.
package logging
...
// Logger wraps slog.Logger with service-level fields pre-attached.
type Logger struct {
	inner *slog.Logger
}
...
// WithContext returns a child logger with trace_id and span_id from ctx.
